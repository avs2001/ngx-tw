...
const separatorVariants = tv({
  ...
  variants: {
    ...
    color: {
      primary: { line: 'border-primary-border' },
      secondary: { line: 'border-secondary-border' },
      accent: { line: 'border-accent-border' },
      neutral: { line: 'border-border' },
      info: { line: 'border-info-border' },
      success: { line: 'border-success-border' },
      warning: { line: 'border-warning-border' },
      error: { line: 'border-error-border' },
    },
  },
  compoundVariants: [
    // Horizontal weight
