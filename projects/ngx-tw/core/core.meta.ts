...
export const meta = {
  ...
  whenToUse: [
    ...
    'Building your own form control that must report errorState / required / errors to <tw-form-field> — call wireErrorState() from a field initializer and its connect() from ngOnInit, instead of hand-rolling the NgControl + ErrorStateMatcher + ngSubmit plumbing',
