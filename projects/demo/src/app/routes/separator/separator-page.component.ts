  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Separator</h1>
        <p twItemDescription>A visual divider between content sections with optional centered label and accessible ARIA semantics.</p>
      </tw-item>

      <nav twTabNav aria-label="Separator documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
