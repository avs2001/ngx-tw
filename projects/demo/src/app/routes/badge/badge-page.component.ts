  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Badge</h1>
        <p twItemDescription>Display short status labels, counts, or tags with semantic colors.</p>
      </tw-item>

      <nav twTabNav aria-label="Badge documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
