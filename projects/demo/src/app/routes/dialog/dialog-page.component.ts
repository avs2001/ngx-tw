  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Dialog</h1>
        <p twItemDescription>Modal surface for focused tasks — built on CDK Dialog with Tailwind styling, animation, and layout directives.</p>
      </tw-item>

      <nav twTabNav aria-label="Dialog documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
