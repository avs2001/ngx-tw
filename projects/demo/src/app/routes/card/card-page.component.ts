  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Card</h1>
        <p twItemDescription>Versatile container that groups related content with header, body, footer, and media slots.</p>
      </tw-item>

      <nav twTabNav aria-label="Card documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
