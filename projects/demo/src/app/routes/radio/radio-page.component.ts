  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Radio</h1>
        <p twItemDescription>Single-selection control implementing the ARIA radiogroup pattern with arrow-key navigation, roving tabindex, and form integration.</p>
      </tw-item>

      <nav twTabNav aria-label="Radio documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
