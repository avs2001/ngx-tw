  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Date Picker</h1>
        <p twItemDescription>Typable input paired with a popover calendar, with pluggable date adapter and full form integration.</p>
      </tw-item>

      <nav twTabNav aria-label="Date picker documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
