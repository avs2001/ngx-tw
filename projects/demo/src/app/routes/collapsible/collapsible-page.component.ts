  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Collapsible</h1>
        <p twItemDescription>An expandable disclosure section that can stand alone or coordinate with siblings as an accordion or independent group.</p>
      </tw-item>

      <nav twTabNav aria-label="Collapsible documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
