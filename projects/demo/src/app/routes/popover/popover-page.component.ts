      ...
      <tw-item size="lg" class="mb-8">
        ...
        >
          <svg class="size-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            ...
            <path fill-rule="evenodd" d="M13 7a2 2 0 012-2h1a2 2 0 012 2v6a2 2 0 01-2 2h-1a2 2 0 01-2-2V7zm2-.5h1a.5.5 0 01.5.5v6a.5.5 0 01-.5.5h-1a.5.5 0 01-.5-.5V7a.5.5 0 01.5-.5z" clip-rule="evenodd" />
          </svg>
        </div>
        <h1 twItemTitle>Popover</h1>
        <p twItemDescription>Floating dialog panel anchored to a trigger element — supports template or component content, 12 positions, focus trapping, and full ARIA dialog semantics.</p>
      </tw-item>

      <nav twTabNav aria-label="Popover documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
