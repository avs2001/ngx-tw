  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        >
          <tw-icon name="chevron-down" size="sm" />
        </div>
        <h1 twItemTitle>Select</h1>
        <p twItemDescription>Accessible combobox with listbox popup — single and multi selection, optional search, and form integration.</p>
      </tw-item>

      <nav twTabNav aria-label="Select documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
