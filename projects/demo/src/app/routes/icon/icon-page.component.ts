  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        >
          <tw-icon name="star" size="sm" />
        </div>
        <h1 twItemTitle>Icon</h1>
        <p twItemDescription>Renders SVG icons from a registry with semantic colors, sizes, and accessible defaults.</p>
      </tw-item>

      <nav twTabNav aria-label="Icon documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
