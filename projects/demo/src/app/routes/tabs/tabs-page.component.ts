  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        >
          <tw-icon name="layers" size="sm" />
        </div>
        <h1 twItemTitle>Tabs</h1>
        <p twItemDescription>Organizes related content into panels where only one is visible at a time.</p>
      </tw-item>

      <nav twTabNav aria-label="Tabs documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
