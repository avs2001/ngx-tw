  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Item</h1>
        <p twItemDescription>Layout primitive that composes a leading slot, title, description, and trailing slot into a single horizontal row.</p>
      </tw-item>

      <nav twTabNav aria-label="Item documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
