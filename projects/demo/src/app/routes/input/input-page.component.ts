      ...
      <tw-item size="lg" class="mb-8">
        ...
        >
          <svg class="size-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path d="M4 5a2 2 0 00-2 2v6a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2H4zm1 3a.75.75 0 000 1.5v.01a.75.75 0 000 1.5V12h3V8H5z" />
          </svg>
        </div>
        <h1 twItemTitle>Input</h1>
        <p twItemDescription>Attribute directive that adapts a native input or textarea into a FormFieldControl — works standalone or inside a tw-form-field, with every form strategy.</p>
      </tw-item>

      <nav twTabNav aria-label="Input documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
