      ...
      <tw-item size="lg" class="mb-8">
        ...
        >
          <svg class="size-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <rect x="2" y="4" width="16" height="3" rx="1.5" opacity="0.4" />
            <rect x="2" y="9" width="16" height="3" rx="1.5" opacity="0.7" />
            <rect x="2" y="14" width="10" height="3" rx="1.5" />
          </svg>
        </div>
        <h1 twItemTitle>Skeleton</h1>
        <p twItemDescription>Placeholder shapes that mimic content while it loads and prevent layout jump.</p>
      </tw-item>

      <nav twTabNav aria-label="Skeleton documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
