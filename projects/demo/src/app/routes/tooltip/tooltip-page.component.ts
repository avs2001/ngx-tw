  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Tooltip</h1>
        <p twItemDescription>Floating directive that describes a trigger element on hover, focus, or touch with configurable placement, delays, and rich content.</p>
      </tw-item>

      <nav twTabNav aria-label="Tooltip documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
