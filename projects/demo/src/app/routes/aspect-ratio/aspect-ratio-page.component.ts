  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Aspect Ratio</h1>
        <p twItemDescription>Constrains an element to a fixed width-to-height ratio using the native CSS aspect-ratio property.</p>
      </tw-item>

      <nav twTabNav aria-label="Aspect Ratio documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
