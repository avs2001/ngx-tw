  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        >
          <tw-icon name="upload-cloud" size="sm" />
        </div>
        <h1 twItemTitle>File Upload</h1>
        <p twItemDescription>Accessible file selection with drag-and-drop, validation, and form integration.</p>
      </tw-item>

      <nav twTabNav aria-label="File Upload documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
