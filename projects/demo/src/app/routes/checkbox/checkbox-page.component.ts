  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Checkbox</h1>
        <p twItemDescription>A three-state selection control with unchecked, checked, and indeterminate values.</p>
      </tw-item>

      <nav twTabNav aria-label="Checkbox documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
