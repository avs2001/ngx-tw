      ...
      <tw-item size="lg" class="mb-8">
        ...
        >
          <svg class="size-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path fill-rule="evenodd" d="M2 4a2 2 0 012-2h12a2 2 0 012 2v2a2 2 0 01-2 2H4a2 2 0 01-2-2V4zm0 8a2 2 0 012-2h12a2 2 0 012 2v2a2 2 0 01-2 2H4a2 2 0 01-2-2v-2z" clip-rule="evenodd"/>
          </svg>
        </div>
        <h1 twItemTitle>Form Field</h1>
        <p twItemDescription>Structural wrapper that pairs any control with a label, prefix and suffix adornments, hints, and validation errors.</p>
      </tw-item>

      <nav twTabNav aria-label="Form field documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
