  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        >
          <tw-icon name="flip-horizontal-2" size="sm" />
        </div>
        <h1 twItemTitle>Flip Card</h1>
        <p twItemDescription>A two-sided card that rotates in 3D between front and back faces on click, hover, or programmatic control.</p>
      </tw-item>

      <nav twTabNav aria-label="Flip Card documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
