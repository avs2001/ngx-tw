  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Avatar</h1>
        <p twItemDescription>
          Displays user or entity identity with an image, initials, or a projected icon, with an optional status
          indicator and a group stack for rosters.
        </p>
      </tw-item>

      <nav twTabNav aria-label="Avatar documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
