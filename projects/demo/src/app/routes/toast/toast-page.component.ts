  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Toast</h1>
        <p twItemDescription>Transient notifications surfaced through CDK Overlay with stackable positions, pause-on-interaction, swipe-to-dismiss, and a promise helper.</p>
      </tw-item>

      <nav twTabNav aria-label="Toast documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
