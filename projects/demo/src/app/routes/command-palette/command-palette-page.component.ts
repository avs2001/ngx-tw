  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        <h1 twItemTitle>Command Palette</h1>
        <p twItemDescription>Keyboard-driven, searchable modal surface for triggering application commands.</p>
      </tw-item>

      <nav twTabNav aria-label="Command palette documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
