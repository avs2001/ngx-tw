  ...
  template: `
    <div class="mx-auto max-w-4xl px-6 py-12">
      <tw-item size="lg" class="mb-8">
        ...
        >
          <tw-icon name="list-tree" size="sm" />
        </div>
        <h1 twItemTitle>Tree</h1>
        <p twItemDescription>
          Hierarchical, keyboard-navigable tree-view with expand/collapse, optional
          tri-state selection, and a fully templated node.
        </p>
      </tw-item>

      <nav twTabNav aria-label="Tree documentation tabs" class="mb-8">
        <a
          twTabLink
          routerLink="overview"
          routerLinkActive
